  ...
  return (
    <>
      <Topbar
        ...
        subtitle="Search/select an employee by ID, name, or department, then update contact details, position/department, skills & technologies, tools & certifications, experience, and training."
      />
      <PageContent>
        ...
        {selected && (
          <div className="card" style={{ padding: 20 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 16 }}>
              ...
              <div className="field">
                <label>Additional Experience or Training</label>
